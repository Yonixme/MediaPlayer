...
interface DirectoryDBActionListenerNew{
...
class DirectoryDBAdapterNew(
    private val dirDBActionListener: DirectoryDBActionListenerNew
) : RecyclerView.Adapter<DirectoryDBAdapterNew.DirectoryDBHolder>(), View.OnClickListener{
