...
interface DirDBActionListener{
    fun getListDirs(): List<Directory>
...
class DirDBAdapter(
    ...
    private var listDir = listOf<Directory>()
    ...
    override fun onBindViewHolder(holder: DirDBHolder, position: Int) {
        ...
        with(holder.binding){
            ...
            if(dir.isDefaultDir == true) itemMore.visibility = View.INVISIBLE
            isAddToList.isChecked = listDir[position].disEnableForReading ?: true
